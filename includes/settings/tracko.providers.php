...
* to 'plugins/wordpress-tracko/hybridauth/Hybrid/Providers/XING.php' and then add it to 
* $TRACKO_PROVIDERS_CONFIG :
*
*   ARRAY( 
...
*      'default_network'     : If true, it will shows up by default on Admin > TRACKO > Networks
...
* configuration pages (wp-admin/options-general.php?page=wordpress-tracko).
*/
