...
(function($){ 
	$(function(){ 
		$(document).on( 'click', 'a.wp-tracko-provider', function(){
			popupurl = $( '#tracko_popup_base_url' ).val();
...
*/
window.tracko_wordpress_tracko_login = function( config ){
	...
	if( ! jQuery( '#loginform' ).length )
	{
		if( jQuery( '#registerform' ).length )
		{
			...
			var login_uri = jQuery( '#tracko_login_form_uri' ).val();
